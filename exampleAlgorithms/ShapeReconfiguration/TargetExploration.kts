/**
 * Exploration algorithm for (some) target tile shapes with holes without using pebbles. Partially
 * based on arbitrary layer traversal algorithm from https://ris.uni-paderborn.de/record/25126 Based
