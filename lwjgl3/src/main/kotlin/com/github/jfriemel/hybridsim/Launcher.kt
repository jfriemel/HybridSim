...
class Main : CliktCommand() {
    ...
    private val configDir by option(
        ...
        "-C",
        help =
            "Only valid when used together with --no_gui and not used with --configuration_file or --generator. " +
    ...
    private val numTiles by option(
        ...
        "-n",
        help =
            "The number of tiles to be generated by the generator given with --generator when using the GUI. For " +
    ...
    private val numRobots by option(
        ...
        "-k",
        help =
            "The number of robots to be generated by the generator given with --generator when using the GUI. For " +
                "non-gui usage (--nogui), multiple values can be given, separated by commas. Then, the input algorithm " +
    ...
    private val numOverhangs by option(
        ...
        "-m",
        help =
            "The number of overhang tiles to be generated by the generator given with --generator when using the " +
    ...
    private val numRuns by option(
        ...
        "-r",
        help =
            "Only valid when used together with --no_gui. The number of times the input algorithm (--algorithm) " +
    ...
    private val limit by option(
        ...
        "-l",
        help =
            "Only valid when used together with --no_gui. Restricts the number of rounds in a single run. If a " +
    ...
    private val startID by option(
        ...
        "-id",
        help =
            "Only valid when used together with --no_gui. ID of the first simulation run. Subsequent runs get " +
                "increasing IDs.",
    ...
    private val outputFile by option(
        ...
        "-o",
        help =
            "Only valid when used together with --no_gui. The path to a .csv file where a report of the algorithm " +
    ...
    private val seed by option(
        ...
        "-s",
        help =
            "Set a seed for randomness. Note: This may not affect randomness in loaded algorithms or " +
